...
namespace aspCoreAPI
{
    public class Startup
    {
        ...
        {
            services.AddMvc(o => o.OutputFormatters.Add(new XmlDataContractSerializerOutputFormatter()));//To change return data //Header - Accept application/xml //otherwise - Header -  application/json
/*                .AddJsonOptions(o =>
                            {
